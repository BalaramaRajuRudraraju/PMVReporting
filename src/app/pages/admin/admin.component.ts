...
export class AdminComponent implements OnInit {
  ...
  headingsDataSource: MatTableDataSource<Item>;
  subHeadingsDataSource: MatTableDataSource<Item>;
  ...
  ngOnInit() {
    ...
    this.subscriptions.push(this.apiService.get("deals.json").subscribe((response) => {
      this.headings = response;
      this.showSpinner = false;
      this.headingsDataSource = new MatTableDataSource<Item>(this.headings);
      this.subHeadingsDataSource = new MatTableDataSource<Item>(this.headings);
